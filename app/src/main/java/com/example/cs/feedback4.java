        ...
        aprtNo = findViewById(R.id.txtbox_aptno);
            ...
            dn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (view.equals(dn)) {
                        Intent intent = new Intent(feedback4.this, MainActivity.class);
                        ...
                        Toast.makeText(feedback4.this, "Your Feedback has been send!!", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void addDataToFirestore(String apartNo) {
        ...
        dbaptno.add(ApartmentNos).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            ...
            public void onSuccess(DocumentReference documentReference) {
                Toast.makeText(feedback4.this, "Your Apartment No has been added..", Toast.LENGTH_SHORT).show();
            }
        });
